...
import BigRockEditPanel from '../../../client/plan/components/BigRockEditPanel.vue'
import { useBigRockEditor } from '../../../client/plan/composables/useBigRockEditor'

// Mock useFocusTrap to avoid DOM focus manipulation in tests
vi.mock('../../../client/plan/composables/useFocusTrap', function() {
  return {
